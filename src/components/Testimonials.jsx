    ...
    <section className="px-2 py-10 md:px-0">
      <figure className="mx-auto max-w-2xl border-4 border-black p-5 rounded-2xl">
        ...
        <blockquote className="mt-10 text-xl text-gray-900">
          <p>
            “restore.io makes photo restoration a breeze. The intuitive
            step-by-step process is perfect for users of all skill levels.
            Upload your photos, sit back, and watch as they're transformed into
            stunning, like-new images in no time. Highly recommended for anyone
            wanting to rejuvenate their cherished memories!”
          </p>
        </blockquote>
